...
<body style="background: #f0f9fd;">
	<div class="formbody">
    		...
    		<form id="ff_function_create" method="post">
				<ul class="forminfo">
					...
					<li><label><fmt:message key="function.has.permission" />:</label><input name="hasPermission" type="checkbox"
