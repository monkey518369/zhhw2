...
<body style="background: #f0f9fd;">
	<div class="formbody">
    		<div class="formtitle"><span>模块基本信息</span></div>
    		<form id="ff_module_create" method="post">
				<ul class="forminfo">
					<li><label><fmt:message key="module.id" /></label><input name="id" type="text"
						style="width: 345px; height: 32px;" class="easyui-textbox"
						data-options="required:true" /><i>编号不能超过30个字符</i>
					</li>
					<li><label><fmt:message key="module.name" />:</label><input name="name" type="text"
						style="width: 345px; height: 32px;" class="easyui-textbox"
