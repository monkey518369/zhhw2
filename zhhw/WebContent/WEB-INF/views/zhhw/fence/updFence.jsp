...
<body style="background: #f0f9fd;">
	<div class="formbody">
			<div class="formtitle"><span>编辑围栏信息</span></div>
			<form id="fence_update" method="post">
				<ul class="forminfo">
					<li><label><fmt:message key="fence.id" /></label><input name="id" type="text"
						style="width: 345px; height: 30px;" " class="easyui-numberbox"
						data-options="required:true" /><i>主键</i>
					</li>
					<li><label><fmt:message key="fence.fence_name" /></label><input name="fence_name" type="text"
						style="width: 345px; height: 30px;" class="easyui-textbox"
						data-options="required:true" /><i><font color="red">*</font></i>
					</li>
					<li><label><fmt:message key="fence.speed" /></label><input name="speed" type="text"
						style="width: 345px; height: 30px;" class="easyui-numberbox"/>
					</li>
					<li><label><fmt:message key="fence.rate_limit" /></label>
					...
					<li><label><fmt:message key="fence.speed_time" /></label><input name="speed_time" type="text"
						style="width: 345px; height: 30px;" class="easyui-numberbox"/><i>秒</i>
					</li>
					<li><label><fmt:message key="fence.in_alarm_plant" /></label>
					...
					<li><label><fmt:message key="fence.in_alarm_driver" /></label>
						<select id="rate_limit" class="easyui-combobox" name="in_alarm_driver" style="width: 345px; height: 30px;">  
							<option value="1">报警</option>
							<option value="0">不报警</option>
						</select>
					</li>
					<li><label><fmt:message key="fence.out_alarm_plant" /></label>
						<select id="rate_limit" class="easyui-combobox" name="in_alarm_driver" style="width: 345px; height: 30px;">  
							<option value="1">报警</option>
							<option value="0">不报警</option>
						</select>
					</li>
					<li><label><fmt:message key="fence.out_alarm_driver" /></label>
						<select id="rate_limit" class="easyui-combobox" name="in_alarm_driver" style="width: 345px; height: 30px;">  
							<option value="1">报警</option>
							<option value="0">不报警</option>
						</select>
					</li>
					<li><label><fmt:message key="fence.lose_time" /></label>
	...
	function submitForm() {
		$('#fence_update').ajaxSubmit({
			type: 'post',  
			url: "${ctx}/history/addFence" ,  
