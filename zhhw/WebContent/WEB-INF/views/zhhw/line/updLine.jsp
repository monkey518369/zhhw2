...
<body style="background: #f0f9fd;">
	<div class="formbody">
			...
			<form id="line_update" method="post">
				<ul class="forminfo">
					<li><label><fmt:message key="line.id" /></label><input name="id" type="text"
