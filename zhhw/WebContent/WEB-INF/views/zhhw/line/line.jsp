...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/history/line.js"></script>
...
<body style="padding: 0px;" onkeydown="keyDelete()">
				...
				<table id="dg" class="easyui-datagrid"
					...
					<thead>
						<tr>
							...
							<th
								data-options="field:'line_name',align:'center'">
								线路名称
							</th>
	...
	function editModule(){
		...
		if(row){
			var win = $('#window_edit');
			win.window({
				href:'${ctx}/history/toUdpLine',
				onLoad:function(){
					$('#line_update').form('load', row);
				}
			});
			win.window('open');
			return false;
