...
<body style="background: #f0f9fd;">
	<div class="formbody">
    		...
    		<form id="hitch_edit" method="post">
				<ul class="forminfo">
					...
					<li><label><fmt:message key="hitch.plateno" />:</label><input name="fk_truck_id" type="text"
						style="width: 345px; height: 30px;" " class="easyui-combobox"
						id="car" data-options="required:true" /><i>外键</i>
					</li>
					<li><label><fmt:message key="hitch.describe" />:</label><input name="summary" type="text"
	...
	function submitForm() {
		$('#hitch_edit').ajaxSubmit({
       	 	type: 'post',  
            url: "${ctx}/hitchmanage/updHitch" ,  
