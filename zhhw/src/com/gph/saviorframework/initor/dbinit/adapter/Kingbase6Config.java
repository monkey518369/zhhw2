...
public class Kingbase6Config implements DBConfig {
	...
	public Kingbase6Config(String host,Integer port,String schema,String username,String userpwd){
		this.host = host;
		this.port = port;
		this.schema = schema;
		...
		this.url = "jdbc:kingbase://"+this.host+":"+this.port+"/"+this.schema+"";

	}

	@Override
	public DB_TYPE getDbType() {
		return DB_TYPE.KINGBASE6;
	}
	...
	public void updateDbConfigFile(String configFilePath) throws Exception {
		...
		s = StringUtils.replace(s, "DB_DRIVER", "com.kingbase.Driver");
		s = StringUtils.replace(s, "DB_DIALECT", "org.hibernate.dialect.KingbaseDialect");
